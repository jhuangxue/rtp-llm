...
- Path A (xdist): gpu_pin_early.py sets CVD before entry_point plugins
...
class TestGpuIsolation:
    ...
    def test_cvd_is_set(self):
        ...
        assert cvd is not None, (
            ...
            "GPU isolation (gpu_pin_early / device_resource wrapper) did not activate."
        )
        gpus = _cvd_gpus()
